	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet: core.GetGearSet("../../../ui/sims/monk/windwalker/gear_sets", "p5_bis"),
			OtherGearSets: []core.GearSetCombo{
				core.GetGearSet("../../../ui/sims/monk/windwalker/gear_sets", "p4_bis"),
			},
			...
			Rotation:    core.GetAplRotation("../../../ui/sims/monk/windwalker/apls", "default"),
