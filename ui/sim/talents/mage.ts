...
export const mageGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		...
		[MageMajorGlyph.GlyphOfIcyVeins]: {
			...
			description:
				"Your Icy Veins causes your Frostbolt, Frostfire Bolt, Ice Lance, and your Water Elemental\'s Waterbolt spells to split into 3 smaller bolts that each do 40% damage, instead of increasing spell casting speed.",
	...
	minorGlyphs: {
		...
		[MageMinorGlyph.GlyphOfDiscreetMagic]: {
			...
			description:
				'Your Nether Tempest, Living Bomb, Frost Bomb, Arcane Barrage, and Inferno Blast no longer affect targets more than 5 yds away from their primary target.',
