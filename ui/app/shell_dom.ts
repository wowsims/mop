 ...
 * the vanilla shell.
 *
 * A container leaves this interface as its contents become React's — `.sim-toolbar`,
 * `.sim-sidebar-socials` and `.sim-title` did when their contents ported. Handing one out is what lets a component `appendChild` into a subtree
