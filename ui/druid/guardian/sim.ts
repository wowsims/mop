...
import { APLRotation, APLRotation_Type as APLRotationType } from '../../core/proto/apl.js';
import { Debuffs, IndividualBuffs, ItemSlot, PartyBuffs, PseudoStat, RaidBuffs, Spec, Stat } from '../../core/proto/common.js';
...
const SPEC_CONFIG = registerSpecConfig(Spec.SpecGuardianDruid, {
	...
	presets: {
		...
		rotations: [
			...
			Presets.ROTATION_HOTW,
			Presets.ROTATION_EMPRESS,
	...
	constructor(parentElem: HTMLElement, player: Player<Spec.SpecGuardianDruid>) {
		...
		this.reforger = new ReforgeOptimizer(this, {
			getEPDefaults: player =>
				player.getEpWeights().equals(Presets.OFFENSIVE_EP_PRESET.epWeights) ? Presets.OFFENSIVE_PRECAP_EPS : Presets.BALANCED_PRECAP_EPS,
