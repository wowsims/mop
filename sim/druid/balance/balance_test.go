	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet: core.GetGearSet("../../../ui/sims/druid/balance/gear_sets", "t16"),
			OtherGearSets: []core.GearSetCombo{
				core.GetGearSet("../../../ui/sims/druid/balance/gear_sets", "t15"),
			},
			...
			Rotation:       core.GetAplRotation("../../../ui/sims/druid/balance/apls", "standard"),
