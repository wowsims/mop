...
import { DEFAULT_CASTER_GEM_STATS, StatCap, UnitStat } from '@sim/proto/stats';
import { defineSpec } from '@sim/spec_config';
import * as OtherInputs from '@features/settings/model/other_inputs';
import { StatCapType } from '@generated/proto/api';
import { APLRotation, APLRotation_Type, APLValueVariable, SimpleRotation } from '@generated/proto/apl';
import { Cooldowns, IndividualBuffs, ItemSlot, PartyBuffs, PseudoStat, Spec, Stat } from '@generated/proto/common';
...
// Pure precompute hoisted out of the old ctor: merges the shared mage haste
// breakpoints with the Combustion-specific ones for the stat selection preset.
