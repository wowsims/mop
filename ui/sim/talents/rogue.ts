...
export const rogueGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		...
		[RogueMajorGlyph.GlyphOfDeadlyMomentum]: {
			...
			description:
				'When you land a killing blow on an opponent that yields experience or honor, your Slice and Dice and Recuperate abilities are refreshed to their original duration.',
