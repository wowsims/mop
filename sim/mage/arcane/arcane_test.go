	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet: core.GetGearSet("../../../ui/specs/mage/arcane/gear_sets", "p3_bis"),
			OtherGearSets: []core.GearSetCombo{
				core.GetGearSet("../../../ui/specs/mage/arcane/gear_sets", "prebis"),
			},
			...
			Rotation:    core.GetAplRotation("../../../ui/specs/mage/arcane/apls", "arcane_t15_4pc"),
