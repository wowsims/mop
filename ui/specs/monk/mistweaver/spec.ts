...
import { Debuffs, IndividualBuffs, PartyBuffs, PseudoStat, RaidBuffs, Spec, Stat } from '@generated/proto/common';
...
export default defineSpec<Spec.SpecMistweaverMonk>({
	...
	className: 'mistweaver-monk-sim-ui',
	...
	includeBuffDebuffInputs: [BuffDebuffInputs.CritBuff, BuffDebuffInputs.MajorArmorDebuff, BuffDebuffInputs.StaminaBuff],
