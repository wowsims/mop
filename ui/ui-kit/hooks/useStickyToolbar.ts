 ...
 *
 * Parameterises the header the toolbar sticks below and the element type; fixes the observer —
 * the toolbar has stuck exactly when it no longer fits whole under `header`.
 */
export const useStickyToolbar = <T extends HTMLElement>(header: HTMLElement) => {
