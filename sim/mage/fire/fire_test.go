	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet: core.GetGearSet("../../../ui/specs/mage/fire/gear_sets", "p1_bis"),
			OtherGearSets: []core.GearSetCombo{
				core.GetGearSet("../../../ui/specs/mage/fire/gear_sets", "p1_prebis"),
			},
			Talents:         FireTalents,
			...
			Rotation:        core.GetAplRotation("../../../ui/specs/mage/fire/apls", "fire"),
