...
/**
 * Not registered — `individual_sim_ui` carries the line commented out, as it does for the matching
 * 60U EP exporter. Ported anyway so the two halves of the 60U pair live in the same place, and so
 * the shared import tail has one implementation rather than a React one and a vanilla one.
 */
