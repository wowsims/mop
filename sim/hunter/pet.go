...
var DefaultPetConfigs = [...]PetConfig{
	...
	proto.HunterOptions_Fox:          {Name: "Fox", FocusDump: Bite},
	...
	proto.HunterOptions_SpiritBeast:  {Name: "Spirit Beast", FocusDump: Claw},
	...
	proto.HunterOptions_Worm:         {Name: "Worm", FocusDump: Bite, SpecialAbility: AcidSpitDebuff},
	proto.HunterOptions_ShaleSpider:  {Name: "Shale Spider", FocusDump: Bite},
	proto.HunterOptions_Goat:         {Name: "Goat", FocusDump: Bite},
