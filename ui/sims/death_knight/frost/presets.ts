...
import P52hObliterateBuild from './builds/p5.2h-obliterate.build.json';
import P5MasterfrostBuild from './builds/p5.masterfrost.build.json';
import P52HObliterateGear from './gear_sets/p5.2h-obliterate.gear.json';
import P5MasterfrostGear from './gear_sets/p5.masterfrost.gear.json';
import Prebis2HObliterateGear from './gear_sets/prebis.2h-obliterate.gear.json';
import PrebisMasterfrostGear from './gear_sets/prebis.masterfrost.gear.json';
