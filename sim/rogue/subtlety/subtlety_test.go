	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet:       core.GetGearSet("../../../ui/sims/rogue/subtlety/gear_sets", "preraid_subtlety"),
			OtherGearSets: []core.GearSetCombo{
				//core.GetGearSet("../../../ui/sims/rogue/subtlety/gear_sets", "p3_subtlety"),
				//core.GetGearSet("../../../ui/sims/rogue/subtlety/gear_sets", "p4_subtlety"),
			},
			...
			Rotation:       core.GetAplRotation("../../../ui/sims/rogue/subtlety/apls", "subtlety"),
