...
func TestBlood(t *testing.T) {
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		core.GetTestBuildFromJSON(proto.Class_ClassDeathKnight, "../../../ui/specs/death_knight/blood/builds", "iron_juggernaut_default", ItemFilter, nil, nil),
		core.GetTestBuildFromJSON(proto.Class_ClassDeathKnight, "../../../ui/specs/death_knight/blood/builds", "horridon_default", ItemFilter, nil, nil),
		// core.GetTestBuildFromJSON(proto.Class_ClassDeathKnight, "../../../ui/specs/death_knight/blood/builds", "sha_default", ItemFilter, nil, nil),
		{
			Class:      proto.Class_ClassDeathKnight,
			Race:       proto.Race_RaceOrc,
			OtherRaces: []proto.Race{proto.Race_RaceWorgen},

			GearSet: core.GetGearSet("../../../ui/specs/death_knight/blood/gear_sets", "p5"),
			...
			Rotation:    core.GetAplRotation("../../../ui/specs/death_knight/blood/apls", "iron_juggernaut"),
