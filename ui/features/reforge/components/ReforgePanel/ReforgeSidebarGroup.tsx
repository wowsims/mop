...
export const ReforgeSidebarGroup = ({ model, options }: ReforgeSidebarGroupProps) => {
	...
	return (
		<ButtonGroup
			ref={setGroup}
			className="[--settings-button-width:36px] [--reforge-cols:auto_var(--settings-button-width)] w-full grid grid-cols-(--reforge-cols) order-20 suggest-reforges-settings-group ui-reforge-sidebar-actions">
