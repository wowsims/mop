...
func TestBrewmaster(t *testing.T) {
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		core.GetTestBuildFromJSON(proto.Class_ClassMonk, "../../../ui/specs/monk/brewmaster/builds", "iron_juggernaut_default", ItemFilter, nil, nil),
		core.GetTestBuildFromJSON(proto.Class_ClassMonk, "../../../ui/specs/monk/brewmaster/builds", "horridon_default", ItemFilter, nil, nil),
		// core.GetTestBuildFromJSON(proto.Class_ClassMonk, "../../../ui/specs/monk/brewmaster/builds", "sha_default", ItemFilter, nil, nil),
		// core.GetTestBuildFromJSON(proto.Class_ClassMonk, "../../../ui/specs/monk/brewmaster/builds", "garajal_default", ItemFilter, nil, nil),
		{
			Class:      proto.Class_ClassMonk,
			Race:       proto.Race_RaceTroll,
			OtherRaces: []proto.Race{proto.Race_RaceOrc},

			GearSet: core.GetGearSet("../../../ui/specs/monk/brewmaster/gear_sets", "p5_bis_dw"),
			OtherGearSets: []core.GearSetCombo{
				core.GetGearSet("../../../ui/specs/monk/brewmaster/gear_sets", "p5_bis_offensive_dw"),
				core.GetGearSet("../../../ui/specs/monk/brewmaster/gear_sets", "prebis"),
			},
			...
			Rotation:    core.GetAplRotation("../../../ui/specs/monk/brewmaster/apls", "default"),
