...
func TestProtectionWarrior(t *testing.T) {
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		core.GetTestBuildFromJSON(proto.Class_ClassWarrior, "../../../ui/sims/warrior/protection/builds", "iron_juggernaut_default", ItemFilter, nil, nil),
		core.GetTestBuildFromJSON(proto.Class_ClassWarrior, "../../../ui/sims/warrior/protection/builds", "horridon_default", ItemFilter, nil, nil),
		// core.GetTestBuildFromJSON(proto.Class_ClassWarrior, "../../../ui/sims/warrior/protection/builds", "sha_default", ItemFilter, nil, nil),
		// core.GetTestBuildFromJSON(proto.Class_ClassWarrior, "../../../ui/sims/warrior/protection/builds", "garajal_default", ItemFilter, nil, nil),
		{
			...
			GearSet:       core.GetGearSet("../../../ui/sims/warrior/protection/gear_sets", "p5_bis"),
			OtherGearSets: []core.GearSetCombo{
				// core.GetGearSet("../../../ui/sims/warrior/protection/gear_sets", "p2_bis"),
			},
			Talents:     DefaultTalents,
			Glyphs:      DefaultGlyphs,
			Consumables: FullConsumesSpec,
			SpecOptions: core.SpecOptionsCombo{Label: "Basic", SpecOptions: PlayerOptionsBasic},
			Rotation:    core.GetAplRotation("../../../ui/sims/warrior/protection/apls", "default"),
