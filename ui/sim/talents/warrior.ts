...
export const warriorGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		...
		[WarriorMajorGlyph.GlyphOfDieByTheSword]: {
			...
			description:
				'While Die by the Sword is active, using Overpower increases its duration by 1 sec and using Wild Strike increases its duration by 0.5 sec per use.',
		...
		[WarriorMajorGlyph.GlyphOfImpalingThrows]: {
			...
			description:
				'Heroic Throw now leaves an axe in the target, which can be retrieved by moving within 5 yards of the target to finish the cooldown of Heroic Throw. This effect will only occur when Heroic Throw is cast from more than 10 yards away from the target.',
