	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet: core.GetGearSet("../../../ui/specs/mage/frost/gear_sets", "p5_bis"),
			OtherGearSets: []core.GearSetCombo{
				core.GetGearSet("../../../ui/specs/mage/frost/gear_sets", "p1_prebis"),
			},
			...
			Rotation:        core.GetAplRotation("../../../ui/specs/mage/frost/apls", "frost"),
			OtherRotations: []core.RotationCombo{
				core.GetAplRotation("../../../ui/specs/mage/frost/apls", "frost_aoe"),
			},
