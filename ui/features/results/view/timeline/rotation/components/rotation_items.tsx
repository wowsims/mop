...
import { setActionIdBackground } from '@sim/proto/action_id/dom';
import type { AuraUptimeLog, CastLog, DamageLog } from '@sim/proto/combat_log';
...
export function createItemRenderer(row: ContentRow): ItemRenderer {
	...
	if (row.kind === 'cast') {
		...
		setActionIdBackground(row.actionId, iconTemplate);
	}
