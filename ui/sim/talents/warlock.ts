...
export const warlockGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		...
		[WarlockMajorGlyph.GlyphOfSoulConsumption]: {
			...
			description:
				'Your Drain Soul restores 20% of your total health after you kill a target that yields experience or honor. You restore 20% of your total health after you kill a target in Demon Form that yields experience or honor. You restore 20% of your total health after you kill a target with Chaos Bolt that yields experience or honor.',
		...
		[WarlockMajorGlyph.GlyphOfLifeTap]: {
			...
			description:
				'Your Life Tap no longer consumes health, but instead absorbs 0 healing received. This effect stacks.\u000D\u000A\u000D\u000A The absorb lasts 30 sec.',
