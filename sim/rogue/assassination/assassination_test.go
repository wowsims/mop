	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet:    core.GetGearSet("../../../ui/specs/rogue/assassination/gear_sets", "preraid_assassination"),

			OtherGearSets: []core.GearSetCombo{
				//core.GetGearSet("../../../ui/specs/rogue/assassination/gear_sets", "p3_assassination"),
				//core.GetGearSet("../../../ui/specs/rogue/assassination/gear_sets", "p4_assassination"),
			},
			...
			Rotation:       core.GetAplRotation("../../../ui/specs/rogue/assassination/apls", "assassination"),
