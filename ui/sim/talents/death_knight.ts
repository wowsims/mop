...
export const deathKnightGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		...
		[DeathKnightMajorGlyph.GlyphOfDeathCoil]: {
			...
			description:
				'Your Death Coil spell is now usable on all allies. When cast on a non-undead ally, Death Coil shrouds them with a protective barrier that absorbs up to 168 damage.',
		...
		[DeathKnightMajorGlyph.GlyphOfDarkSuccor]: {
			...
			description:
				'When you kill an enemy that yields experience or honor, while in Frost or Unholy Presence, your next Death Strike within 15s is free and will restore at least 20% of your maximum health.',
