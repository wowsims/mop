	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet:       core.GetGearSet("../../../ui/specs/rogue/subtlety/gear_sets", "preraid_subtlety"),
			OtherGearSets: []core.GearSetCombo{
				//core.GetGearSet("../../../ui/specs/rogue/subtlety/gear_sets", "p3_subtlety"),
				//core.GetGearSet("../../../ui/specs/rogue/subtlety/gear_sets", "p4_subtlety"),
			},
			...
			Rotation:       core.GetAplRotation("../../../ui/specs/rogue/subtlety/apls", "subtlety"),
