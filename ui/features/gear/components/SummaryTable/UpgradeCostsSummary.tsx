					...
					<div key={key}>
						<SummaryTableRow>
							<div className="flex items-center">
								<img
									className="gem-icon ui-summary-table-gem-icon static cursor-default rounded-none inline-block size-[calc(4*var(--gem-width)/5)] z-1 bg-no-repeat bg-cover bg-center"
