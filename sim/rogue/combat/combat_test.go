	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet:       core.GetGearSet("../../../ui/specs/rogue/combat/gear_sets", "preraid_combat"),
			OtherGearSets: []core.GearSetCombo{
				//core.GetGearSet("../../../ui/specs/rogue/combat/gear_sets", "p3_combat"),
			...
			Rotation:       core.GetAplRotation("../../../ui/specs/rogue/combat/apls", "combat"),
