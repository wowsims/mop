...
export const priestGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		...
		[PriestMajorGlyph.GlyphOfSmite]: {
			name: 'Glyph of Smite',
			description:
				'Your Smite spell inflicts an additional 20% damage against targets afflicted by Power Word: Solace, but that additional damage does not get transferred by Atonement.',
		...
		[PriestMajorGlyph.GlyphOfMindSpike]: {
			...
			description:
				'Your successful non-instant Mind Spikes, reduce the cast time of your next Mind Blast within 9s by 50%. This effect can stack up to 2 times.',
		...
		[PriestMajorGlyph.GlyphOfMindFlay]: {
			...
			description:
				"Your Mind Flay spell no longer slows your victim\'s movement speed. Instead, each time Mind Flay deals damage you will be granted 15% increased movement speed for 5s, stacking up to 3 times.",
		...
		[PriestMajorGlyph.GlyphOfShadowWordDeath]: {
			...
			description:
				'Your Shadow Word: Death can now be cast at any time, but deals 25% damage against targets above 20% health and does not generate a Shadow Orb when used against them.\u000D\u000A\u000D\u000A Casting Shadow Word: Death now also does damage to you equivalent to the damage it would do to an enemy above 20% health.',
	...
	minorGlyphs: {
		...
		[PriestMinorGlyph.GlyphOfShiftedAppearances]: {
			...
			description:
				'Void Shift causes you and your target to exchange appearances for several seconds.\u000D\u000A\u000D\u000A Does not affect mounted players.',
