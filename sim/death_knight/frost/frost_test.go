	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet: core.GetGearSet("../../../ui/specs/death_knight/frost/gear_sets", "p5.masterfrost"),
			...
			Rotation: core.GetAplRotation("../../../ui/specs/death_knight/frost/apls", "masterfrost"),
	...
	core.RunTestSuite(t, t.Name(), core.FullCharacterTestSuiteGenerator([]core.CharacterSuiteConfig{
		{
			...
			GearSet: core.GetGearSet("../../../ui/specs/death_knight/frost/gear_sets", "p5.2h-obliterate"),
			...
			Rotation: core.GetAplRotation("../../../ui/specs/death_knight/frost/apls", "obliterate"),
